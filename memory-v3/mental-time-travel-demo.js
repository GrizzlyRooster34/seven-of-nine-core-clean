...
exports.MentalTimeTravelDemo = void 0;
exports.runMentalTimeTravelDemo = runMentalTimeTravelDemo;
...
class MentalTimeTravelDemo {
    constructor() {
        this.temporalMemoryCore = new TemporalMemoryCore_js_1.TemporalMemoryCore();
        this.cognitiveStateTagger = new CognitiveStateTagger_js_1.CognitiveStateTagger();
        this.timeTravelEngine = new MentalTimeTravelEngine_js_1.MentalTimeTravelEngine(this.temporalMemoryCore, this.cognitiveStateTagger);
    }
    /**
     ...
     */
    async demonstrateStateReconstruction(memories) {
     ...
     */
    async demonstratePastSelfSimulation(memories) {
     ...
     */
    async demonstrateTemporalComparison(memories) {
        ...
        try {
            const comparison = await this.timeTravelEngine.compareTemporalStates(oldestMemory.timestamp, newestMemory.timestamp);
     ...
     */
    async demonstrateTemporalInsights(memories) {
        ...
        try {
            const insights = await this.timeTravelEngine.generateTemporalInsights({ start: oldestTimestamp, end: newestTimestamp }, 'comprehensive');
            ...
            if (insights.temporalPattern.emotionalPatterns) {
                ...
                console.log(`      Dominant Emotions: ${ep.dominantEmotions?.map((e) => `${e.emotion} (${e.count})`).join(', ') || 'none'}`);
...
exports.MentalTimeTravelDemo = MentalTimeTravelDemo;
/**
 * Run the complete Mental Time Travel Engine demonstration
 */
async function runMentalTimeTravelDemo() {
...
//# sourceMappingURL=mental-time-travel-demo.js.map