...
exports.createCognitiveStateTagger = exports.CognitiveStateTagger = void 0;
class CognitiveStateTagger {
    constructor() {
        this.isActive = false;
        ...
        // Configuration
        this.MONITORING_FREQUENCY = 5000; // 5 seconds
        this.PATTERN_ANALYSIS_FREQUENCY = 30000; // 30 seconds
...
exports.CognitiveStateTagger = CognitiveStateTagger;
// Export for use in Temporal Memory Core
exports.default = CognitiveStateTagger;
const createCognitiveStateTagger = () => new CognitiveStateTagger();
exports.createCognitiveStateTagger = createCognitiveStateTagger;
