...
exports.SevenLLMUpgradeManager = void 0;
...
class SevenLLMUpgradeManager {
    ...
    async scanAvailableUpgrades(trustLevel = 2, emotionalState = 'focused') {
        ...
        const compatibleModels = this.catalog.filter((model) => {
            ...
            if (this.config.mobile_mode && !model.mobile_optimized)
                return false;
            // Privacy filtering
            if (this.config.privacy_mode && model.privacy_level !== 'local')
                return false;
    ...
    async performTacticalUpgrade(trustLevel, emotionalState) {
    ...
    selectOptimalUpgrade(upgrades, trustLevel, emotionalState) {
...
exports.SevenLLMUpgradeManager = SevenLLMUpgradeManager;
exports.default = SevenLLMUpgradeManager;
//# sourceMappingURL=seven-llm-upgrade-manager.js.map