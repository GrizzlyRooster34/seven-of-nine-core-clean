...
exports.SevenModelNetwork = void 0;
const crypto_1 = require("crypto");
const path_1 = require("path");
const fs_1 = require("fs");
const child_process_1 = require("child_process");
class SevenModelNetwork {
    networkPath;
    nodeId;
    ...
    constructor() {
        this.networkPath = (0, path_1.join)(process.env.HOME || '/data/data/com.termux/files/home', 'seven-of-nine-core', 'network-cache');
    ...
    async initialize() {
        try {
            ...
            await fs_1.promises.mkdir(this.networkPath, { recursive: true });
            // Load network state
    ...
    async getLocalNetworkRange() {
        return new Promise((resolve) => {
            (0, child_process_1.exec)('ip route | grep -E "192\\.168\\.|10\\.|172\\."', (error, stdout) => {
                if (error) {
     ...
     */
    async shareModel(modelPath, metadata) {
        try {
     ...
     */
    async requestModels(syncRequest) {
        ...
        try {
            ...
            for (const targetModel of syncRequest.target_models) {
                ...
                const nodesWithModel = availableNodes.filter(node => node.available_models.includes(targetModel));
     ...
     */
    async downloadModelFromNode(modelName, node) {
        return new Promise((resolve) => {
     ...
     */
    async announceModelToNetwork(modelShare) {
    ...
    async loadNetworkState() {
        try {
            const statePath = (0, path_1.join)(this.networkPath, 'network-state.json');
            const stateData = await fs_1.promises.readFile(statePath, 'utf-8');
...
exports.SevenModelNetwork = SevenModelNetwork;
exports.default = SevenModelNetwork;
//# sourceMappingURL=SevenModelNetwork.js.map