...
exports.Phase1To4IntegrationTest = void 0;
const logic_engine_js_1 = require("../core/logic-engine.js");
class Phase1To4IntegrationTest {
    logicEngine;
    constructor() {
        this.logicEngine = new logic_engine_js_1.SevenLogicEngine();
    }
    ...
    async testEmotionalMemoryIntegration() {
    ...
    async testBehavioralMemoryIntegration() {
    ...
    async testReflexPatternLearning() {
    ...
    async testChristineMemoryHandling() {
    ...
    async testComplexMultiPhaseResponse() {
...
exports.Phase1To4IntegrationTest = Phase1To4IntegrationTest;
...
//# sourceMappingURL=phase-1-4-integration.test.js.map