...
const MemoryEncryption_1 = require("../memory-v3-amalgum/MemoryEncryption");
class TemporalMemoryCore extends MemoryEngine_js_1.MemoryEngine {
    temporalMemoryPath;
    temporalMemoryFile;
    temporalMemories = [];
    cognitiveStateTagger; // Will be injected by CognitiveStateTagger
    temporalEncryptionEngine;
    temporalEncryptionEnabled = true;
