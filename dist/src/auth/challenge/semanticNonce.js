...
class SemanticNonceChallenge {
    CHALLENGE_STORE_PATH = (0, path_1.join)(process.cwd(), 'security', 'semantic-challenges');
    LORE_BASE_PATH = (0, path_1.join)(process.cwd(), 'security', 'creator-lore.json');
    DEFAULT_TIME_WINDOW_MS = 15000; // 15 seconds
    MIN_RESPONSE_TIME_MS = 2000; // 2 seconds (prevent pre-computation)
    MAX_RESPONSE_TIME_MS = 30000; // 30 seconds
    activeChallenges = new Map();
    creatorLoreBase = null;
    constructor() {
