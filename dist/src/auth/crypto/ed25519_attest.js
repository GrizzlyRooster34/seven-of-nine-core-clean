...
class Ed25519Attestation {
    KEYSTORE_PATH = (0, path_1.join)(process.cwd(), 'security', 'device-keys');
    NONCE_STORE_PATH = (0, path_1.join)(process.cwd(), 'security', 'nonces');
    CHALLENGE_EXPIRY_MS = 300000; // 5 minutes
    MAX_CLOCK_SKEW_MS = 30000; // 30 seconds
    MIN_TRUST_LEVEL = 7; // 0-10 scale
